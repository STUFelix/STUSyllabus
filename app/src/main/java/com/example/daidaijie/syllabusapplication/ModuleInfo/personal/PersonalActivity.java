...
public class PersonalActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new PersonalAdapter(getSupportFragmentManager());
...
//      修改两个Tab的文字
        mTabLayout.getTabAt(0).setText("我的消息");
        mTabLayout.getTabAt(1).setText("我的评论");
    }
