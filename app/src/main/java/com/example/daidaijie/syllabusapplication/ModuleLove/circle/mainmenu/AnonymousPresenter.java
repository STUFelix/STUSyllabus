...
import com.example.daidaijie.syllabusapplication.ModuleLove.circle.ISchoolCircleModel;
...
public class AnonymousPresenter implements AnonymousContract.presenter, CirclesAdapter.OnLongClickCallBack {
    ...
    @Inject
    @PerFragment
    public AnonymousPresenter(ISchoolCircleModel ISchoolCircleModel,
                              AnonymousContract.view view,
    ...
    public void refresh() {
        ...
        mISchoolCircleModel.loadAnoListFromNet(pageIndex)
    ...
    public void loadData() {
        ...
        mISchoolCircleModel.getAnoListFromNet(pageIndex)
                .subscribe(new Subscriber<List<PostListBean>>() {
                    @Override
                    public void onCompleted() {
