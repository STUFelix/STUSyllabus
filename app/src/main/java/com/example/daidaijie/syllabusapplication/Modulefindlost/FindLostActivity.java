...
public class FindLostActivity extends BaseActivity {
    ...
    FindLostPagerAdapter mPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new FindLostPagerAdapter(getSupportFragmentManager());
...
//      修改两个Tab的文字
        mTabLayout.getTabAt(0).setText("寻主");
        mTabLayout.getTabAt(1).setText("寻物");
    }
