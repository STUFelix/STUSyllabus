...
public abstract class CourseWorkExpandableTextAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public CourseWorkExpandableTextAdapter() {
        super();
    ...
    public void onBindViewHolder(final T holder, final int position) {
        ...
        if(state == null){
             ...
             * 根据下标设置内容（作业详情）
             * */
            contentTV.setText(CourseWorkUtil.getContent(position));
