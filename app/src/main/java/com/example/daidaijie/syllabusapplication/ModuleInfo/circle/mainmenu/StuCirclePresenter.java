...
import com.example.daidaijie.syllabusapplication.ModuleInfo.circle.ISchoolCircleModel;
...
public class StuCirclePresenter implements StuCircleContract.presenter, CirclesAdapter.OnLongClickCallBack {
    ...
    public void refresh() {
        ...
        mISchoolCircleModel.loadCircleListFromNet(mView.getTAB(),pageIndex)
    ...
    public void loadData() {
        ...
        mISchoolCircleModel.getCircleListFromNet(mView.getTAB(),pageIndex)
                .subscribe(new Subscriber<List<PostListBean>>() {
                    @Override
                    public void onCompleted() {
