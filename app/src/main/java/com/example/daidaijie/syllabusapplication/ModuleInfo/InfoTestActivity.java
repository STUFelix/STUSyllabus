...
import com.example.daidaijie.syllabusapplication.ModuleInfo.tempPackage.InfoPageAdapter;
...
//        mPagerAdapter = new StuCirclePagerAdapter(getSupportFragmentManager());
        mInfoPageAdapter = new InfoPageAdapter(getSupportFragmentManager());
//        mContainerViewPager.setAdapter(mPagerAdapter);
        mContainerViewPager.setAdapter(mInfoPageAdapter);
...
//      修改两个Tab的文字
        ...
        mTabLayout.getTabAt(2).setText("研究");
        mTabLayout.getTabAt(3).setText("实习");
    }
